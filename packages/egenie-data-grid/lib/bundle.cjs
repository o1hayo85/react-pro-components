...
function EditCell({
  ...
  if (column.editor != null) {
    ...
    if ((_column$editorOptions = column.editorOptions) != null && _column$editorOptions.createPortal) {
      content = /*#__PURE__*/reactDom.createPortal(content, editorPortalTarget);
    }
  }
...
function Row({
  ...
  const [hoverClassName, setClassName] = react.useState('');
...
function DataGrid({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(HeaderRow$1, {
      ...
      }), summaryRows == null ? void 0 : summaryRows.map((row, rowIdx) => /*#__PURE__*/jsxRuntime.jsx(SummaryRow$1, {
