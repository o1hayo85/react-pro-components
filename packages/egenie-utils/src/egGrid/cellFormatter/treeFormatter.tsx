...
export function toggleSubRow(rows: Row[], id: StrOrNum, primaryKeyField: StrOrNum): Row[] {
  try {
...
export function deleteSubRow(rows: Row[], id: StrOrNum, primaryKeyField: StrOrNum): Row[] {
...
export function subRowReducer(rows: Row[], { type, id, primaryKeyField }: SubRowAction): Row[] {
  switch (type) {
    case 'toggleSubRow':
      return toggleSubRow(rows, id, primaryKeyField);
    case 'deleteSubRow':
      return deleteSubRow(rows, id, primaryKeyField);
    default:
      return rows;
  }
}
