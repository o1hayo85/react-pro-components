...
```bash
yarn upgrade egenie-common egenie-data-grid egenie-utils egenie-code-style egenie-config egenie-react-scripts egenie-test --latest
```
...
+   "prettier": "prettier -c --write \"**/*.{css,less,md,html,json}\""
  },
  "config": {
    "commitizen": {
